<?php /* Smarty version Smarty-3.1.13, created on 2021-08-09 15:54:54
         compiled from "../template/template/user/boss.html" */ ?>
<?php /*%%SmartyHeaderCode:1221079822610d2ffb70d2a8-36444631%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'baebddc29f4079be88c37f9a06203156a96284e3' => 
    array (
      0 => '../template/template/user/boss.html',
      1 => 1628495691,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1221079822610d2ffb70d2a8-36444631',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_610d2ffb75bfc3_66262781',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_610d2ffb75bfc3_66262781')) {function content_610d2ffb75bfc3_66262781($_smarty_tpl) {?><!DOCTYPE html>
<html>
...
<script>
    new Vue({
        ...
        methods: {
            getList() {
                console.log('getlist')
                axios.get('http://89tr.chengchen.com/index/getBossDate')
                    .then((response)=> {
            ...
            async handleSubmit() {
                ...
                axios({
                    method : 'post',
                    url : `http://89tr.chengchen.com/index/upBossDate`,
                    data : {param : param},
