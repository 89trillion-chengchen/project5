 ...
 * SVN:         $Id: smarty_internal_utility.php 770 2014-03-06 03:48:22Z pengcheng2 $
 * 
...
class Smarty_Internal_Utility {
    ...
    public static function testInstall(Smarty $smarty, &$errors = null) {
        ...
        if (is_dir($source)) {
            $expected = array("smarty_cacheresource.php" => true,
        ...
        if (is_dir($source)) {
            $expected = array("block.textformat.php" => true,
